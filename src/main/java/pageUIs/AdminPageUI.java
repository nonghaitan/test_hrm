...
public class AdminPageUI {
    ...
    public static final String SEARCH_USERNAME = "xpath=//label[text()='Username']/parent::div/following-sibling::div/input";
    ...
    public static final String EMPLOYEE_NAME = "xpath=//input[@placeholder='Type for hints...']";
    ...
    public static final String SUCCESS_TOAST = "xpath=//p[contains(text(),'Successfully Saved')]";
}
